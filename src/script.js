(function () {
  ...
  const DATA_TOKEN = document.currentScript?.getAttribute("data-token");
  ...
  // Event listeners
  window.addEventListener("hashchange", _sendAnalytics);
  ...
  if (his.pushState) {
    ...
    window.addEventListener("popstate", _sendAnalytics);
  }
